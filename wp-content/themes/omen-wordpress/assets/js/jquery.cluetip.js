  ...
  $.cluetip = {
    ...
    */
    defaults: {
      ...
      width:            240,      // The width of the clueTip
      ...
      leftOffset:       -240,       // Number of px to offset clueTip from left of invoking element
      ...
      clickThrough:     true,     // if true, and activation is not 'click', then clicking on link will take user 
                                  // to the link's href, even if href and tipAttribute are equal
